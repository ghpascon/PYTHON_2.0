...
def create_docx_with_charts(tickers, start_date, end_date, docx_filename):
    """
...
if __name__ == "__main__":
    ...
    end_date = "2024-11-28"  # Data de hoje
    
    # Nome do arquivo DOCX
    docx_filename = "analise_ibovespa_regressao_linear_com_tabela_valores.docx"
    
    # Criar o arquivo DOCX com os gráficos e a tabela
    create_docx_with_charts(tickers, start_date, end_date, docx_filename)
